...
public class ColaboradorController {
    ...
    public String atualizarColaborador(@PathVariable Long id, @Valid Colaborador colaborador, BindingResult result, Model model) {
        if (result.hasErrors()) {
    ...
    public String listarColaboradores(Model model) {
        ...
        //model.addAttribute("acessoAdmin", acessoAdmin); // Adiciona o atributo acessoAdmin ao Model
